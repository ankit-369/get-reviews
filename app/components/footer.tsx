        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
          ...
          <div className="flex items-center justify-center relative mb-6 md:mb-0">
            <a href="http://localhost:3000" className="relative p-4">
              ...
              <div className="absolute bottom-3 right-3 w-16 h-16 border-b-4 border-r-4 border-green-500 transform translate-x-4 translate-y-4 transition-transform duration-500 hover:scale-110"></div>
            </a>
          </div>
      
          {/* Navigation Links */}
          <div className="flex space-x-6">
            <a href="https://github.com/ankit-369/get-reviews" target="_blank" className="text-gray-400 hover:text-green-400 transition-colors duration-300">
            ...
            <a href="https://twitter.com/_x_ankit" target="_blank" className="text-gray-400 hover:text-green-400 transition-colors duration-300">
              <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
