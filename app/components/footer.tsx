export function Footer(){
  const nextAuthUrl = process.env.NEXT_PUBLIC_NEXTAUTH_URL;
    ...
    return (
        <footer className="bg-[#191919] text-[#ECDBBA] py-10">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
          ...
          <div className="flex items-center justify-center relative mb-6 md:mb-0">
            <a href={nextAuthUrl} className="relative p-4">
              ...
              <div className="absolute top-3 left-3 w-16 h-16 border-t-4 border-l-4 border-[#C84B31] transform -translate-x-4 -translate-y-4 transition-transform duration-500 hover:scale-110"></div>
              <div className="absolute bottom-3 right-3 w-16 h-16 border-b-4 border-r-4 border-[#C84B31] transform translate-x-4 translate-y-4 transition-transform duration-500 hover:scale-110"></div>
            </a>
          </div>
      
          {/* Navigation Links */}
          <div className="flex space-x-6">
            <a href="https://github.com/ankit-369/get-reviews" 
               target="_blank" 
               className="text-[#2D4263] hover:text-[#C84B31] transition-colors duration-300">
            ...
            <a href="https://twitter.com/_x_ankit" 
               target="_blank" 
               className="text-[#2D4263] hover:text-[#C84B31] transition-colors duration-300">
              <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
        ...
        {/* Footer Bottom */}
        <div className="mt-8 text-center text-[#2D4263]">
