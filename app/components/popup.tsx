  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.message === 'Form submitted successfully') {
        ...
        setTimeout(() => {
          window.location.href = '/testimonial/youtube-yalear'; // Redirect to a success page
      ...
      :
        ...
        <div className="bg-white rounded-lg shadow-2xl w-11/12 md:w-2/3 lg:w-1/2 p-8 relative border border-gray-200">
          ...
          <div className="flex items-center justify-center mb-6">
            <Image src={data?.image || '/public/user/default.png'} alt="Avatar" width={120} height={120} className="rounded-full border-4 border-blue-300 shadow-lg" />
          </div>
          <div className="mb-6">
