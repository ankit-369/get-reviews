...
export default function Space() {
  ...
  return (
    <>
      ...
      <div className="p-4 flex below-900:flex-col after-900:flex-row min-h-screen bg-gray-900 " >
        ...
        <div id="logo-sidebar" className=" xl:ml-10 sticky	top-0 left-0 z-40 after-900:max-w-64 after-900:pt-20 transition-transform  border-r  dark:bg-gray-900 dark:border-gray-700">
          <div className="after-900:h-full overflow-hidden px-3 pb-4 overflow-y-auto dark:bg-gray-900">
            <ul className="flex justify-center items-center below-900:flex-row below-900:space-x-2 flex-col space-y-2 font-medium after-900:justify-normal after-900:items-start after-900:flex-wrap  after-900:space-x-0 after-900:space-y-2">
              <li>
                <button onClick={() => settab("dashboard")} className={`flex  md:ml-3 items-center p-2  rounded-lg text-white  hover:bg-gray-700 group ${tab === 'dashboard' ? 'bg-gray-700' : ''}`}>
                  <svg className="w-7 h-7  transition duration-75 text-gray-400  group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
              ...
              <li>
                <button onClick={() => settab("liked")} className={`flex ml-3 md:ml-4 w-full h-10 items-center p-1  rounded-lg text-white  hover:bg-gray-700 group ${tab === 'liked' ? 'bg-gray-700' : ''}`}>
                  <svg className="flex-shrink-0   transition duration-75 text-gray-400  group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
              ...
              <li>
                <button onClick={() => settab("integrate")} className={`flex ml-4 w-full items-center p-2 rounded-lg text-white  hover:bg-gray-700 group ${tab === 'integrate' ? 'bg-gray-700' : ''}`}>
              ...
              <li>
                <button onClick={() => settab("widget")} className={`flex ml-4 w-full items-center p-2  rounded-lg text-white  hover:bg-gray-700 group ${tab === 'widget' ? 'bg-gray-700' : ''}`}>
                  <svg className="flex-shrink-0 w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white" fill="currentColor" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 121.92">
